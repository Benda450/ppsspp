...
static ConfigSetting themeSettings[] = {
	ConfigSetting("CanaryItemStyleFgCanary", &g_Config.uItemStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ItemStyleBgCanary", &g_Config.uItemStyleBg, 0x55000000, true, false),
	ConfigSetting("ItemFocusedStyleFgCanary", &g_Config.uItemFocusedStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ItemFocusedStyleBgCanary", &g_Config.uItemFocusedStyleBg, 0xFFEA486E, true, false), //0xFFEDC24C
	ConfigSetting("ItemDownStyleFgCanary", &g_Config.uItemDownStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ItemDownStyleBgCanary", &g_Config.uItemDownStyleBg, 0xFFE81949, true, false), //0xFFBD9939
	ConfigSetting("ItemDisabledStyleFgCanary", &g_Config.uItemDisabledStyleFg, 0x80EEEEEE, true, false),
	ConfigSetting("ItemDisabledStyleBgCanary", &g_Config.uItemDisabledStyleBg, 0x55E0D4AF, true, false),
	ConfigSetting("ItemHighlightedStyleFgCanary", &g_Config.uItemHighlightedStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ItemHighlightedStyleBgCanary", &g_Config.uItemHighlightedStyleBg, 0xFFE83949, true, false), //0x55BDBB39

	ConfigSetting("ButtonStyleFgCanary", &g_Config.uButtonStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ButtonStyleBgCanary", &g_Config.uButtonStyleBg, 0x55000000, true, false),
	ConfigSetting("ButtonFocusedStyleFgCanary", &g_Config.uButtonFocusedStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ButtonFocusedStyleBgCanary", &g_Config.uButtonFocusedStyleBg, 0xFFEA486E, true, false), //0xFFEDC24C
	ConfigSetting("ButtonDownStyleFgCanary", &g_Config.uButtonDownStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ButtonDownStyleBgCanary", &g_Config.uButtonDownStyleBg, 0xFFE81949, true, false), //0xFFBD9939
	ConfigSetting("ButtonDisabledStyleFgCanary", &g_Config.uButtonDisabledStyleFg, 0x80EEEEEE, true, false),
	ConfigSetting("ButtonDisabledStyleBgCanary", &g_Config.uButtonDisabledStyleBg, 0x55E0D4AF, true, false),
	ConfigSetting("ButtonHighlightedStyleFgCanary", &g_Config.uButtonHighlightedStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("ButtonHighlightedStyleBgCanary", &g_Config.uButtonHighlightedStyleBg, 0xFFE83949, true, false), //0x55BDBB39

	ConfigSetting("HeaderStyleFgCanary", &g_Config.uHeaderStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("InfoStyleFgCanary", &g_Config.uInfoStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("InfoStyleBgCanary", &g_Config.uInfoStyleBg, 0x00000000U, true, false),
	ConfigSetting("PopupTitleStyleFgCanary", &g_Config.uPopupTitleStyleFg, 0xFFF27391, true, false), //0xFFE3BE59
	ConfigSetting("PopupStyleFgCanary", &g_Config.uPopupStyleFg, 0xFFFFFFFF, true, false),
	ConfigSetting("PopupStyleBgCanary", &g_Config.uPopupStyleBg, 0xFF303030, true, false),
